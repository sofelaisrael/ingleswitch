  ...
  return (
    <section className="bg-[#020B0C] py-24 px-6 md:px-20 font-[nunito]">
      <div className="mx-auto bg-linear-to-b from-[#151A1D] to-[#071827] py-20 max-md:py-10 w-full flex flex-col gap-3 justify-between items-center text-center text-white">
        ...
        <div className="head text-[53px] max-md:text-[32px] max-md:leading-[30px]  px-40 max-md:px-4 max-lg:px-7 leading-[50px] py-5">
          Tech Inclined Innovative Solutions For Clients
        </div>
        <div className="content px-60 max-md:px-4 max-lg:px-10 text-gray-500">
